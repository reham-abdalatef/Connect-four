...
mov dx,2FBh            ;Address of line control register
...
mov dx,2F8h            ;Divisor Latch Low [DLAB=1]
mov al,0Ch              
Out dx,al

mov dx,2F9h            ;Divisor Latch High [DLAB=0]
mov al,0
Out dx,al
;Divisor = 00 0C ; The Baud Rate =9600

mov dx,2FBh              ;Return to LCR
...
Send proc near
CheckSend:
mov dx,2FDh   ;Read the line status register`
In al,dx
